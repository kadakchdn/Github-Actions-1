...
//* A staging configuration containing a Staging URL */
      ...
      if ( cli.hasOption( "h" ) ) {
        ...
        formatter.printHelp("java -jar GitHub_Actions", SuiteExecutionWrapper.instance().getOptions() );
        System.exit( 0 );
      }

      if ( cli.hasOption( "q" ) ) {
        System.out.println( "Suite" );
        System.out.println( "GitHub Actions (Suite): 32438.2766" ); 
        System.out.println( "\r\nTests" );
        System.out.println( "Test1 (Test): 32438.2776" );
        
        System.out.println( "\r\nFunctions" );
        
        
        System.out.println( "\r\nExecution Targets" );
	System.out.println( "GitHub Actions router (Router): 32438.2769" );
	System.out.println( "Chrome (Execution Target): 32438.2770" );
	System.out.println( "Firefox (Execution Target): 32438.2771" );
	System.out.println( "Microsoft Edge (Execution Target): 32438.2772" );
	
        System.out.println( "\r\nSites and Pages" );
        System.out.println( "www.facebook.com (Site): 32438.2778" );
        System.out.println( "Facebook  log in or sign up (Page): 32438.2782" );
        
        System.out.println( "\r\nData Sources" );
        
        System.out.println( "\r\nPlugins" );
        System.out.println( "Integrated Selenium Server (Plugin): 32438.2767" );
        System.out.println( "HTML Generator (Plugin): 32438.2773" );
        System.out.println( "Alchemy Execution Console (Plugin): 32438.2774" );
      ...
      if ( cli.hasOption( "a" ) ) {
        ...
        SuiteExecutionWrapper.instance().setName("GitHub Actions");
      }
      if ( cli.hasOption( "u" ) ) {
      ...
      if ( cli.hasOption( "d" ) ) {
        ...
        SuiteExecutionWrapper.instance().setDescription("No description was added for GitHub Actions");
      }
      ...
      if ( hasValue( "it", "32438.2776" ) ) {
        if ( 0 == 0 || ( 0 == 1 && cli.hasOption( "rd" ) ) || ( 0 == 2 && cli.hasOption( "rq" ) ) ) {
          TestManager.instance().registerTest( new org.org_1.github_actions.test1() );
          testList.add("Test1");
        }
      }
      ...
      Router r;
      /*
      Routers from GitHub Actions Execution Package
      Add a description of GitHub Actions Execution Package
      */
      if ( hasValue( "ir", "32438.2769" ) ) { 
        r = new Router( 1, "GitHub Actions router", "32438.2769" ,"{\"name\":\"GitHub Actions router\",\"description\":\"Add a description of GitHub Actions router\",\"alchemyId\":2769,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"routerId\":1,\"status\":0,\"userId\":0,\"propertyList\":[{\"name\":\"URL\",\"value\":\"http://localhost:4444/wd/hub\"}],\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\"}" );
      ...
      ExecutionTarget eT;
      /*
      Targets from GitHub Actions Execution Package
      Add a description of GitHub Actions Execution Package
      */
      if ( hasValue( "ie", "32438.2770" ) ) {
        eT = new ExecutionTarget( "Chrome", "32438.2770", "32438.2769", 2 ,"{\"name\":\"Chrome\",\"description\":\"Add a description of Chrome\",\"alchemyId\":2770,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"chrome\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0}" );
      ...
      if ( hasValue( "ie", "32438.2771" ) ) {
        eT = new ExecutionTarget( "Firefox", "32438.2771", "32438.2769", 2 ,"{\"name\":\"Firefox\",\"description\":\"Add a description of Firefox\",\"alchemyId\":2771,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"firefox\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0}" );
        if ( eT.getMaximumAvailable() > 0 ) {
      ...
      if ( hasValue( "ie", "32438.2772" ) ) {
        eT = new ExecutionTarget( "Microsoft Edge", "32438.2772", "32438.2769", 2 ,"{\"name\":\"Microsoft Edge\",\"description\":\"Add a description of Microsoft Edge\",\"alchemyId\":2772,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"MicrosoftEdge\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0}" );
        if ( eT.getMaximumAvailable() > 0 ) {
    ...
    public void start() {
      ...
      suitePayload.setSuiteDetail(  "{\"id\":7153,\"name\":\"GitHub Actions\",\"description\":\"No description was added for GitHub Actions\",\"userId\":12,\"userConfidence\":0,\"organizationId\":1,\"organizationConfidence\":0,\"status\":1,\"endpointId\":1,\"endpointStyleId\":1,\"targetId\":7321,\"targetConfigurationId\":0,\"targetVersionId\":0,\"reviewFlag\":0,\"importTests\":0,\"importFunctions\":0,\"importSites\":0,\"importTargets\":0,\"importData\":0,\"shareCount\":0,\"conductorList\":[{\"reviewFlag\":0,\"id\":6411,\"name\":\"GitHub Actions Execution Package\",\"description\":\"Add a description of GitHub Actions Execution Package\",\"alchemyId\":2768,\"alchemySeed\":32438,\"organizationId\":1,\"userId\":12,\"version\":0,\"targetDetail\":\"[{\\\"name\\\": \\\"Chrome\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2770, \\\"createDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"modifyDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"alchemySeed\\\": 32438, \\\"description\\\": \\\"Add a description of Chrome\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"chrome\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2769, \\\"alchemySeed\\\": 32438}}, {\\\"name\\\": \\\"Firefox\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2771, \\\"createDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"modifyDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"alchemySeed\\\": 32438, \\\"description\\\": \\\"Add a description of Firefox\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"firefox\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2769, \\\"alchemySeed\\\": 32438}}, {\\\"name\\\": \\\"Microsoft Edge\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2772, \\\"createDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"modifyDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"alchemySeed\\\": 32438, \\\"description\\\": \\\"Add a description of Microsoft Edge\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"MicrosoftEdge\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2769, \\\"alchemySeed\\\": 32438}}]\",\"routerDetail\":\"[{\\\"name\\\": \\\"GitHub Actions router\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"routerId\\\": 1, \\\"alchemyId\\\": 2769, \\\"createDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"modifyDate\\\": \\\"Mar 28, 2025, 1:59:13 PM\\\", \\\"alchemySeed\\\": 32438, \\\"description\\\": \\\"Add a description of GitHub Actions router\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"URL\\\", \\\"value\\\": \\\"http://localhost:4444/wd/hub\\\"}], \\\"organizationId\\\": 0}]\",\"status\":1,\"lockUserId\":0,\"changed\":false,\"createDate\":\"Mar 28, 2025, 1:59:32 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:32 PM\",\"targetList\":[{\"name\":\"Chrome\",\"description\":\"Add a description of Chrome\",\"alchemyId\":2770,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"chrome\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0},{\"name\":\"Firefox\",\"description\":\"Add a description of Firefox\",\"alchemyId\":2771,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"firefox\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0},{\"name\":\"Microsoft Edge\",\"description\":\"Add a description of Microsoft Edge\",\"alchemyId\":2772,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2769,\"alchemySeed\":32438},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"MicrosoftEdge\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\",\"referenceSuiteID\":0}],\"routerList\":[{\"name\":\"GitHub Actions router\",\"description\":\"Add a description of GitHub Actions router\",\"alchemyId\":2769,\"alchemySeed\":32438,\"organizationId\":0,\"changed\":false,\"routerId\":1,\"status\":0,\"userId\":0,\"propertyList\":[{\"name\":\"URL\",\"value\":\"http://localhost:4444/wd/hub\"}],\"createDate\":\"Mar 28, 2025, 1:59:13 PM\",\"modifyDate\":\"Mar 28, 2025, 1:59:13 PM\"}],\"acls\":[]}],\"version\":1,\"lockUserId\":0,\"testDisplay\":0,\"alchemyId\":2766,\"alchemySeed\":32438,\"referenceSuiteID\":0,\"changed\":false}" );
